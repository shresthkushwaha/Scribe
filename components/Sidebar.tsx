...
function SidebarContent() {
    ...
    const pastelColors = ['#E8A8A8', '#A8C8E8', '#A8E8BA', '#E8D0A8'];
    ...
    return (
        ...
        >
            ...
            <div className="flex-1 overflow-y-auto overflow-x-hidden flex flex-col gap-8 no-scrollbar">
                ...
                <div className="flex flex-col gap-1">
                    ...
                    {uniqueTags.map(([tag], i) => (
                        ...
                        >
                            <div className="w-[8px] h-[8px] rounded-full flex-shrink-0" style={{ background: pastelColors[i % pastelColors.length] }} title={isCollapsed ? tag : undefined} />
            ...
            <div className="mt-auto pt-6">
                <Link
                    href="/notes/new"
                    className={`flex justify-center items-center gap-2 p-3.5 w-full rounded-[var(--radius-md)] text-[14px] font-semibold transition-transform hover:-translate-y-[1px] shadow-[0_4px_12px_rgba(62,56,56,0.15)] ${isCollapsed ? 'px-0' : ''}`}
